...
const Works = () => {
  ...
  const getCardWrapperClassName = (index: number) => {
    switch (index) {
      case 0:
        return "sticky top-[2vh] z-0 max-w-full mb-64";
      case 1:
        return "sticky top-[4vh] z-1 max-w-full mb-64";
      case 2:
        return "sticky top-[6vh] z-2 max-w-full mb-64";
      case 3:
        return "sticky top-[8vh] z-3 max-w-full mb-64";
      case 4:
        return "sticky top-[10vh] z-4 max-w-full mb-96";
      case 5:
