  ...
  return (
    ...
    <div className="flex flex-col justify-center">
      <div className="flex flex-col px-5 py-7 max-md:max-w-full">
        <div className="self-end text-2xl text-[#E4E4E4] max-md:mr-2.5">
          MORE +
        </div>
        <motion.div
          style={{
        ...
        >
          <div className="self-start -ml-12 -mt-24 font-medium text-[#EEBDFF] text-[300px] max-md:max-w-full max-md:text-4xl">
            Camryn
          </div>
        </motion.div>
          ...
          <div className="max-md:max-w-full">
            <div className="flex gap-5 max-md:flex-col max-md:gap-0">
              <div className="flex flex-col max-md:ml-0 max-md:w-full">
                <div className="mt-28 text-2xl text-left text-[#E4E4E4] max-md:mt-10">
                  Front-end developer based in Canada. Passionate about human
              ...
              <div className="flex flex-col ml-5 w-[77%] max-md:ml-0 max-md:w-full">
                ...
                >
                  <div className="font-medium text-[#EEBDFF] text-[300px] max-md:mt-9 max-md:max-w-full max-md:text-4xl">
                    Roadley
                  </div>
                </motion.div>
              </div>
